...
class RtlSdrSource:
    ...
    def open(self):
        ...
        self._check(self._lib.rtlsdr_open(ctypes.byref(self._dev), self.cfg.device_index), "rtlsdr_open")
    ...
    def read_iq(self) -> np.ndarray:
        ...
        self._check(self._lib.rtlsdr_read_sync(self._dev, self._buf, self._num_bytes, ctypes.byref(self._n_read)), "read_sync")
